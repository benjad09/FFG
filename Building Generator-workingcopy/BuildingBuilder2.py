...
class building:
	...
	def createroom(self):
		for i in range(0,len(self.rooms)):
			if "r" in self.rooms[i]["name"]:
				self.rooms[i]["hotzwall"] = []
				self.rooms[i]["vertwall"] = [[],[]]
				room_x = self.rooms[i]["cordinates"][0]
				room_y = self.rooms[i]["cordinates"][1]
				room_w = self.rooms[i]["cordinates"][2]
				room_h = self.rooms[i]["cordinates"][3]
				for j in range(0,room_h):
					self.rooms[i]["hotzwall"].append([])
					if self.horizontalwalls[j+room_y][room_x] == 2:
						self.rooms[i]["hotzwall"][-1].append("d")
					elif self.horizontalwalls[j+room_y][room_x] == 3:
						self.rooms[i]["hotzwall"][-1].append("v")
					else:
						self.rooms[i]["hotzwall"][-1].append("w")
					if self.horizontalwalls[j+room_y][room_x+room_w] == 2:
						self.rooms[i]["hotzwall"][-1].append("d")
					elif self.horizontalwalls[j+room_y][room_x+room_w] == 3:
						self.rooms[i]["hotzwall"][-1].append("v")
					else:
						self.rooms[i]["hotzwall"][-1].append("w")
				for j in range(0,room_w):
					if self.verticalwalls[room_y][room_x+j] == 2:
						self.rooms[i]["vertwall"][0].append("d")
					elif self.verticalwalls[room_y][room_x+j] == 3:
						self.rooms[i]["vertwall"][0].append("v")
					else:
						self.rooms[i]["vertwall"][0].append("w")
					if self.verticalwalls[room_y+room_h][room_x+j] == 2:
						self.rooms[i]["vertwall"][1].append("d")
					elif self.verticalwalls[room_y+room_h][room_x+j] == 3:
						self.rooms[i]["vertwall"][1].append("v")
					else:
						self.rooms[i]["vertwall"][1].append("w")
				print(self.rooms[i]["name"])
				for j in self.rooms[i]["hotzwall"]:
					print(j)
				for j in self.rooms[i]["vertwall"]:
					print(j)
